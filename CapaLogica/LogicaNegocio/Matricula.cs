...
namespace SistemaMatricula.CapaLogica.LogicaNegocio
{
    public class Matricula
    {
        ...
        /// <param name="Pmatricula_comprobante"></param>
        /// <param name="Pprofesor_estado"></param>
        public Matricula(int Pestudiante_id, int Pgrupo_id, int Pcurso_id, int Pprofesor_id, int Phorario_id, int Paula_id, string Pmatricula_comprobante, string PMatricula_estado)
        {
            Matricula_id = 0;
        ...
        /// 
        /// </summary>
        /// <param name="Pmatricula_id"></param>
        /// <param name="Pestudiante_id"></param>
        /// <param name="Pgrupo_id"></param>
        /// <param name="Pcurso_id"></param>
        /// <param name="Pprofesor_id"></param>
        ...
        /// <param name="Pmatricula_comprobante"></param>
        /// <param name="Pprofesor_estado"></param>
        public Matricula(int Pmatricula_id, int Pestudiante_id, int Pgrupo_id, int Pcurso_id, int Pprofesor_id, int Phorario_id, int Paula_id, string Pmatricula_comprobante, string PMatricula_estado)
        {
