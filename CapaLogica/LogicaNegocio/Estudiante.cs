...
namespace SistemaMatricula.CapaLogica.LogicaNegocio
{
    public class Estudiante
    {
        ...
        public Estudiante(int Pgrupo_id, string Pestudiante_cedula, string Pestudiante_nombre, string Pestudiante_primerApellido, string Pestudiante_segundoApellido, string Pestudiante_telefono, string Pestudiante_correoElectronico, string Pestudiante_direccion, string Pestudiante_estado)
        {
            Estudiante_id = 0;
            Grupo_id = Pgrupo_id;
        ...
        /// 
        /// </summary>
        /// <param name="Pestudiante_id"></param>
        /// <param name="Pgrupo_id"></param>
        /// <param name="Pestudiante_cedula"></param>
        /// <param name="Pestudiante_nombre"></param>
        /// <param name="Pestudiante_primerApellido"></param>
        ...
        /// <param name="Pestudiante_direccion"></param>
        /// <param name="Pestudiante_estado"></param>
        public Estudiante(int Pestudiante_id, int Pgrupo_id, string Pestudiante_cedula, string Pestudiante_nombre, string Pestudiante_primerApellido, string Pestudiante_segundoApellido, string Pestudiante_telefono, string Pestudiante_correoElectronico, string Pestudiante_direccion, string Pestudiante_estado)
        {
