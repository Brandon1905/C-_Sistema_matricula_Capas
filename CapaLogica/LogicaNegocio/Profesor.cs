...
namespace SistemaMatricula.CapaLogica.LogicaNegocio
{
    public class Profesor
    {
        ...
        /// <summary>
        /// manejo de prosedimiento almacenado de insertar profesor
        /// </summary>
        ...
        public Profesor(string Pprofesor_cedula, string Pprofesor_nombre, string Pprofesor_primerApellido, string Pprofesor_segundoApellido, string Pprofesor_telefono, string Pprofesor_correoElectronico, string Pprofesor_direccion, string Pprofesor_estado)
        {
            Profesor_id = 0;
        ...
        /// <param name="Pprofesor_direccion"></param>
        /// <param name="Pprofesor_estado"></param>
        public Profesor(int Pprofesor_id,string Pprofesor_cedula, string Pprofesor_nombre, string Pprofesor_primerApellido, string Pprofesor_segundoApellido, string Pprofesor_telefono, string Pprofesor_correoElectronico, string Pprofesor_direccion, string Pprofesor_estado)
        {
